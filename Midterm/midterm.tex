...
For this problem we start with a three node cluster state. The state of the qubits after the two $C_{z}$ gates is given by:

{
\begin{gather*}
C_{z}^{(1,2)}C_{z}^{(2,3)}\ket{+}_1\ket{+}_2\ket{+}_3 \\
