...
{
\begin{gather*}
X^{m_1}\ket{\psi_2}=\frac{1}{\sqrt2}\cos{(\alpha_1/2)}\ket{0}_2\ket{+}_3\\
...
{
\begin{gather*}
X^{m_2}\ket{\psi_{4}}=\ket{\psi_5}=\frac{1}{\sqrt2}\cos{(\frac{\alpha_1}{2})}e^{-i\alpha_2/2}\ket{+}_3\\
-\frac{i}{\sqrt2}\sin{(\frac{\alpha_1}{2})}e^{i\alpha_2/2}\ket{-}_3
\end{gather*}
}%

We observe that in the circuit given below the two highlighted boxes are both one-bit teleportations. The output of the circuit is $X^{m_2}HZ_{\pm\alpha2}X^{m_1}HZ_{\alpha1}\ket{+}$, where $m_1$ and $m_2$ are the outputs for the first and second qubits. 
\begin{gather*}
\Qcircuit @C=1em @R=1.2em{
