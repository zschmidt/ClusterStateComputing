...
For this problem we prepare a three node cluster state given by: 
{
\begin{gather*}
...
-\frac{i}{\sqrt2}\sin{(\alpha_1/2)}\ket{1}_2\ket{3}_3=\ket{\psi3}
\end{gather*}
}%
...
{
\begin{gather*}
X^{m_2}\ket{\psi_{4}}=\frac{1}{\sqrt2}\cos{(\frac{\alpha_1}{2})}e^{-i\alpha_2/2}\ket{+}_3\\
