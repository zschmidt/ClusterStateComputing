...
\begin{gather*}
\Qcircuit @C=0.5em@R=0.5em{
\lstick{\ket{+}_1} & \ctrl{1} & \qw & \gate{HZ_{\alpha1}} & \meter & \cwx \\
\lstick{\ket{+}_2} & \gate{CZ} & \ctrl{1} & \qw & \gate{HZ_{\pm\alpha2}} \cwx & \meter \\
...
\begin{gather*}
\Qcircuit @C=1em@R=1.2em{
\lstick{\ket{+}_1} & \ctrl{1} & \gate{ HZ_{\alpha1}} & \meter & \cwx \\
\lstick{\ket{+}_2} & \gate{CZ} } & \qw & \gate{HZ_{\pm\alpha2}\cwx & \meter  \\
\lstick{\ket{+}_3} & \qw & \qw & \qw 
}
\end{gather*}
